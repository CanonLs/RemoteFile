...
gulp.task('default', gulp.series('css', 'scss', 'imgLoad', 'reload', 'es6', async () => {
...
gulp.task('zip', gulp.parallel('clean', 'js', 'nanoCss', 'html', 'moveImg'), () => {
    console.log('执行压缩');
    return gulp
        .src(outPath.all)
...
gulp.task('build', gulp.parallel('clean', 'js', 'nanoCss', 'reg', 'moveImg', 'zip'), function() {
